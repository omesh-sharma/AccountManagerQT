...
#define ACC_NO = "accountNumber"
#define NAME = 'name'
#define DESC = 'description'
#define DATE = 'date'
#define CHECK_NO = 'checkNo'
#define CREDIT_DEB = 'credit_debit'
#define PREVB = 'previousBalance'
...
public:
    ...
    vector<string> VaccountNumber, Vname, Vdescription, Vdate, VcheckNo, Vcredit_debit, VpreviousBalance, newBal;
